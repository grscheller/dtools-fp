...
class Test_fp_no_sc_folds:
    def test_fold(self) -> None:
        ...
        assert foldL_sc(data3, add) is nada
        # assert foldR_sc(data3, add) is nada
        ...
        assert foldL_sc(stuff3, add) is nada
        # assert foldR_sc(stuff3, add) is nada
        assert foldL_sc(stuff4, add) == 42
        # assert foldR_sc(stuff4, add) == 42

        assert foldL_sc(stuff1, funcL, sentinel=None) == -156
        # assert foldR_sc(stuff1, funcR, sentinel=None) == 0
        assert foldL_sc(stuff2, funcL, sentinel=None) == 84
        # assert foldR_sc(stuff2, funcR, sentinel=None) == 39
        assert foldL_sc(stuff3, funcL, sentinel=None) == None
        # assert foldR_sc(stuff3, funcR, sentinel=None) == None
        assert foldL_sc(stuff4, funcL, sentinel=None) == 42
        # assert foldR_sc(stuff4, funcR, sentinel=None) == 42
        ...
        assert foldL_sc(stuff3, funcL) is nada
        # assert foldR_sc(stuff3, funcR) is nada
    ...
    def test_fold_sc(self) -> None:
        ...
        assert foldL_sc(data1, add2) == 15
    #   assert foldR_sc(data1, add) == 15
        assert foldL_sc(data2, add2) == 36
    #   assert foldR_sc(data2, add) == 36
        assert foldL_sc(data3, add2) == 21
    #   assert foldR_sc(data3, add) == 21
        assert foldL_sc(data4, add2) is nada
    #   assert foldR_sc(data4, add) == nada
        assert foldL_sc(data5, add2) == 10
    #   assert foldR_sc(data5, add) == 10
        assert foldL_sc(data6, add2) == 35
    #   assert foldR_sc(data6, add) == 30
        assert foldL_sc(data1, add2, 10) == 25
    #   assert foldR_sc(data1, add, 10) == 25
        assert foldL_sc(data2, add2, 10) == 38
    #   assert foldR_sc(data2, add, 10) == 37
        assert foldL_sc(data3, add2, 20) == 41
    #   assert foldR_sc(data3, add, 20) == 39
        assert foldL_sc(data4, add2, 10) == 10
    #   assert foldR_sc(data4, add, 10) == 10
        assert foldL_sc(data5, add2, 10) == 20
    #   assert foldR_sc(data5, add, 10) == 20
        assert foldL_sc(data6, add2, 10) == 25
    #   assert foldR_sc(data6, add, 10) == 40
